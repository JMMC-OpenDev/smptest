...
#*******************************************************************************
# NAME 
# smpinsInstall - deploy AppLauncher modules and dependencies
# 
# SYNOPSIS
# smpinsInstall [-h] [-c] [-u] [-m] [-t tag]|[-r rtag]|[-b branch]
# 
# DESCRIPTION
# This command retreives all the modules needed for AppLauncher from the SVN
# repository and install them.
#

# Determine the SW package
export SW_PACKAGE=APPLNCHR
